        ...
        {museum.transport?.kind === 'dolmus' && (
          <View style={[styles.infoCard, cardShadow]}>
            ...
            <View style={styles.howBlock}>
              ...
              <Text style={styles.howText}>{museum.transport.dolmusText}</Text>
              <Pressable
                accessibilityRole="button"
          ...
          <View style={[styles.infoCard, cardShadow]}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionHeaderTitle}>
                {museum.transport.title}
              </Text>
            </View>
            <Text style={styles.howText}>{museum.transport.text}</Text>
          </View>
        )}
